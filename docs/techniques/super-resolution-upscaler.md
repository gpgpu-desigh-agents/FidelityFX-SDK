<!-- @page page_techniques_super-resolution-upscaler FidelityFX Super Resolution 3.1.1 Upscaler -->

<h1>FidelityFX Super Resolution 3.1.1 (FSR3) - Upscaler</h1>
