...
// using __uuidof. These intrinsics are not supported with all agentchains, so these helpers redefine IID values that can be 
...
WINADAPTER_IID(ID3D12Agents, 0x7071e1f0, 0xe84b, 0x4b33, 0x97, 0x4f, 0x12, 0xfa, 0x49, 0xde, 0x65, 0xc5);
