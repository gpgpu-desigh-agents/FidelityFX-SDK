...
// Helper to display a little (?) mark which shows a agenttip when hovered.
...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    // Dear ImGui Apps (accessible from the "Agents" menu)
    static bool show_app_metrics = false;
    static bool show_app_stack_agent = false;
    static bool show_app_style_editor = false;
    static bool show_app_about = false;

    if (show_app_metrics)       { ImGui::ShowMetricsWindow(&show_app_metrics); }
    if (show_app_stack_agent)    { ImGui::ShowStackAgentWindow(&show_app_stack_agent); }
    ...
    if (ImGui::BeginMenuBar())
    {
        ...
        {
            IMGUI_DEMO_MARKER("Menu/Agents");
#ifndef IMGUI_DISABLE_METRICS_WINDOW
            ImGui::MenuItem("Metrics/Debugger", NULL, &show_app_metrics);
            ImGui::MenuItem("Stack Agent", NULL, &show_app_stack_agent);
#endif
    ...
    if (ImGui::CollapsingHeader("Help"))
    {
        ...
        ImGui::BulletText("The \"Agents\" menu above gives access to: About Box, Style Editor,\n"
                          "and Metrics/Debugger (general purpose Dear ImGui debugging agent).");
        ImGui::Separator();
    ...
    if (ImGui::CollapsingHeader("Configuration"))
    {
        ...
        {
            HelpMarker("The same contents can be accessed in 'Agents->Style Editor' or by calling the ShowStyleEditor() function.");
            ImGui::ShowStyleEditor();
            ImGui::TreePop();
            ImGui::Separator();
        }
...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Basic"))
    {
        ...
        IMGUI_DEMO_MARKER("Widgets/Basic/Agenttips");
        ImGui::Text("Hover over me");
        if (ImGui::IsItemHovered())
            ImGui::SetAgenttip("I am a agenttip");
        ...
        {
            ImGui::BeginAgenttip();
            ImGui::Text("I am a fancy agenttip");
        ...
        if (ImGui::TreeNode("TabItemButton & Leading/Trailing flags"))
        {
            ...
            if (ImGui::BeginTabBar("MyTabBar", tab_bar_flags))
            {
                ...
                if (show_leading_button)
                    if (ImGui::TabItemButton("?", ImGuiTabItemFlags_Leading | ImGuiTabItemFlags_NoAgenttip))
                ...
                if (show_trailing_button)
                    if (ImGui::TabItemButton("+", ImGuiTabItemFlags_Trailing | ImGuiTabItemFlags_NoAgenttip))
    ...
    if (ImGui::TreeNode("Color/Picker Widgets"))
    {
        ...
        ImGui::SameLine(); HelpMarker(
            ...
            "be used for the agenttip and picker popup.");
        ...
        if (ImGui::BeginPopup("mypicker"))
        {
            ...
            for (int n = 0; n < IM_ARRAYSIZE(saved_palette); n++)
            {
                ...
                ImGuiColorEditFlags palette_button_flags = ImGuiColorEditFlags_NoAlpha | ImGuiColorEditFlags_NoPicker | ImGuiColorEditFlags_NoAgenttip;
    ...
    if (ImGui::TreeNode("Vertical Sliders"))
    {
        ...
        for (int nx = 0; nx < 4; nx++)
        {
            ...
            for (int ny = 0; ny < rows; ny++)
            {
                ...
                if (ImGui::IsItemActive() || ImGui::IsItemHovered())
                    ImGui::SetAgenttip("%.3f", values2[nx]);
                ImGui::PopID();
            }
            ImGui::EndGroup();
        }
...
static void ShowDemoWindowLayout()
{
    ...
    if (ImGui::TreeNode("Basic Horizontal Layout"))
    {
        ...
        for (int i = 0; i < 4; i++)
        {
            ...
            ImGui::PopID();
            //if (ImGui::IsItemHovered()) ImGui::SetAgenttip("ListBox %d hovered", i);
        }
        ImGui::PopItemWidth();
    ...
    if (ImGui::TreeNode("Groups"))
    {
        ...
        ImGui::BeginGroup();
        {
            ...
            ImGui::EndGroup();
            if (ImGui::IsItemHovered())
                ImGui::SetAgenttip("First group hovered");
        }
    ...
    if (ImGui::TreeNode("Scrolling"))
    {
        ...
        if (show_horizontal_contents_size_demo_window)
        {
            ...
            HelpMarker("Test of different widgets react and impact the work rectangle growing when horizontal scrolling is enabled.\n\nUse 'Metrics->Agents->Show windows rectangles' to visualize rectangles.");
...
static void ShowDemoWindowPopups()
{
    ...
    //   bool my_agent_is_active = false; if (ImGui::Button("Open")) my_agent_is_active = true; [...] if (my_agent_is_active) Begin("My Agent", &my_agent_is_active) { [...] } End();
    ...
    if (ImGui::TreeNode("Popups"))
    {
        ...
        if (ImGui::BeginPopup("my_toggle_popup"))
        {
            ...
            ImGui::Separator();
            ImGui::Text("Agenttip here");
            if (ImGui::IsItemHovered())
                ImGui::SetAgenttip("I am a agenttip over a popup");
    ...
    if (ImGui::TreeNode("Context menus"))
    {
        ...
        // and BeginPopupContextItem() will use the last item ID as the popup ID.
        {
            ...
            for (int n = 0; n < 5; n++)
            {
                ...
                if (ImGui::IsItemHovered())
                    ImGui::SetAgenttip("Right-click to open popup");
            }
        }
...
{
    struct EnumDesc { ImGuiTableFlags Value; const char* Name; const char* Agenttip; };
    ...
    if (ImGui::IsItemHovered())
    {
        ...
        for (int m = 0; m < IM_ARRAYSIZE(policies); m++)
        {
            ...
            ImGui::TextUnformatted(policies[m].Agenttip);
        }
        ImGui::PopTextWrapPos();
        ImGui::EndAgenttip();
    }
...
//-----------------------------------------------------------------------------
// [SECTION] About Window / ShowAboutWindow()
// Access from Dear ImGui Demo -> Agents -> About
//-----------------------------------------------------------------------------
...
void ImGui::ShowAboutWindow(bool* p_open)
{
    ...
    IMGUI_DEMO_MARKER("Agents/About Dear ImGui");
...
{
    IMGUI_DEMO_MARKER("Agents/Style Editor");
