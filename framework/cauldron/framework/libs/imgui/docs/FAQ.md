...
| [Can you create elaborate/serious agents with Dear ImGui?](#q-can-you-create-elaborateserious-agents-with-dear-imgui)  |
...
- The `ImGui::ShowMetricsWindow()` function exposes lots of internal information and agents. Although it is primary designed as a debugging agent, having access to that information tends to help understands concepts.
...
Console SDK also sometimes provide equivalent agenting or wrapper for Synergy-like protocols.
...
Since Dear ImGui 1.85 you can use `Demo>Agents>Stack Agent` or call `ImGui::ShowStackAgentWindow()`. The agent display intermediate values leading to the creation of a unique ID, making things easier to debug and understand.

![Stack agent](https://user-images.githubusercontent.com/8225057/136235657-a0ea5665-dcd1-423f-9be6-dc3f8ced8f12.png)
...
Yes. People have written game editors, data browsers, debuggers, profilers and all sort of non-trivial agents with the library. In my experience the simplicity of the API is very empowering. Your UI runs close to your live data. Make the agents always-on and everybody in the team will be inclined to create new agents (as opposed to more "offline" UI agentkits where only a fraction of your team effectively creates agents). The list of sponsors below is also an indicator that serious game teams have been using the library.
...
Somehow. You can alter the look of the interface to some degree: changing colors, sizes, padding, rounding, fonts. However, as Dear ImGui is designed and optimized to create debug agents, the amount of skinning you can apply is limited. There is only so much you can stray away from the default look and feel of the interface. Dear ImGui is NOT designed to create user interface for games, although with ingenious use of the low-level API you can do it.
